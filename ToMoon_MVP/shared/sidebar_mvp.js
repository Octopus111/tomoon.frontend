...
const sidebarConfig = {
    ...
    navigation: [
        ...
        },
        {
            ...
            items: [
                { id: 'sessions', label: 'Sessions', href: '../execute/index.html?view=sessions' },
                { id: 'blueprint', label: 'Blueprint', href: '../execute/index.html?view=blueprint' }
            ]
        },
        {
            id: 'vault',
...
function autoInitSidebar(options = {}) {
    ...
    if (path.includes('/home/')) {
        ...
        currentPage = 'execute';
        if (!currentSubItem) currentSubItem = 'sessions';
